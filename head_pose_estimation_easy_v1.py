# python head_pose_estimation_easy_v1.py --model intel/head-pose-estimation-adas-0001/FP16/head-pose-estimation-adas-0001 --video images/car.png --output_path outputs
...
class Inference:
    ...
    def predict(self, image, initial_w, initial_h):
        ...
        result = self.head_pose_estimation(result)
        # Vehicle output
    ...
    def head_pose_estimation(self, result):
        ...
        angle_r_fc = (result['angle_r_fc'][0][0])
        angle_r_fc_02 = result['angle_r_fc']
        angle_r_fc_flatten = result['angle_r_fc'].flatten()
        #takes the first entry from the list with 'angle_r_fc' and add it to the list output(s)
        outputs.append(result['angle_r_fc'].tolist()[0][0])
        outputs2.append(result['angle_r_fc'][0][0])
        print("--------") 
        print ("angle_r_fc: " +str(angle_r_fc))
        print ("angle_r_fc_02: " +str(angle_r_fc_02))
        print ("angle_r_fc_flatten: " +str(angle_r_fc_02))
        print ("outputs: " +str(outputs))
        print ("outputs2: " +str(outputs2))
        print("--------")
        
        
        angle_y_fc = (result['angle_y_fc'][0][0])
        outputs.append(result['angle_y_fc'].tolist()[0][0])
        outputs2.append(result['angle_y_fc'][0][0])
        
        angle_p_fc = (result['angle_p_fc'][0][0])
        outputs.append(result['angle_p_fc'].tolist()[0][0])
        outputs2.append(result['angle_p_fc'][0][0])
